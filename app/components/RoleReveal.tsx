...
export function RoleReveal({ children }: RoleRevealProps) {
  ...
  return (
    <button
      type="button"
      className="relative flex flex-col items-center justify-center h-[480px] w-full max-w-sm mx-auto cursor-pointer select-none touch-none bg-transparent border-none p-0"
    ...
    >
      {/* Revealed Content */}
      <div
        className={`transition-all duration-200 ease-in-out flex flex-col items-center space-y-6 w-full ${
          isRevealed
