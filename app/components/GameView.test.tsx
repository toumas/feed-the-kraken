...
describe("GameView", () => {
    ...
    it("renders role information", () => {
        ...
        expect(screen.getByText("Steer the ship to safety! Trust no one but your fellow sailors.")).toBeDefined();
    });
    ...
    it("calls onDenialOfCommand when confirmed", () => {
        ...
        render(<GameView {...defaultProps} onDenialOfCommand={onDenialOfCommand} />);
    ...
    it("renders eliminated state when player is eliminated", () => {
        ...
        expect(screen.getByText("You have chosen Denial of Command. You are eliminated from the game.")).toBeDefined();
