      ...
      <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-6 animate-in fade-in duration-1000">
        <div className="max-w-md w-full bg-slate-900 border border-slate-800 p-6 space-y-6 rounded-2xl">
          <div className="flex items-center gap-3 pb-4 border-b border-slate-800">
            ...
            <h1 className="text-xl font-bold text-white">Cult's Guns Stash</h1>
          </div>

          <div className="text-center space-y-4">
            <p className="text-slate-300">
              Close your eyes and reach out your hand. <br />
          ...
          <div className="max-w-md w-full space-y-6">
            ...
            >
              <Quiz.Header
                ...
                description="Answer correctly to please the Great Old One."
              />
        ...
        <div className="max-w-md w-full mx-auto space-y-6">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 space-y-4">
            <div className="flex justify-between items-center px-2">
              <p className="text-sm text-slate-400">Distribute 3 guns total.</p>
              <span
            ...
            <div className="pt-4 text-center border-t border-slate-800">
              <p className="text-sm font-bold text-slate-500">
                {3 - usedGuns === 0
                  ? "Distribution complete. Waiting for timer..."
                  : `Distribute ${3 - usedGuns} more gun${3 - usedGuns !== 1 ? "s" : ""}`}
              </p>
            </div>
          </div>
        </div>
            ...
            {myGuns > 0 ? (
              <>
                ...
                <h2 className="text-xl font-bold text-white">
                  You received {myGuns} gun{myGuns > 1 ? "s" : ""}!
                </h2>
                <p className="text-slate-400">Use them wisely.</p>
              </>
            ) : (
              <>
                <Ghost className="w-16 h-16 text-slate-600 mx-auto" />
                <h2 className="text-xl font-bold text-white">Empty Hands</h2>
                <p className="text-slate-400">
                  You did not receive any guns from the stash.
                </p>
              </>
            )}
          </div>
