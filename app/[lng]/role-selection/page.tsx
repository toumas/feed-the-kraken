    ...
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center">
      <div className="max-w-md w-full bg-slate-900 border border-slate-800 p-6 space-y-6">
        <div className="flex items-center gap-3 pb-4 border-b border-slate-800">
          ...
          <h1 className="text-xl font-bold text-white">{t("roleSelection.title")}</h1>
        </div>
...
function getRoleColorClass(role: Role): string {
  switch (role) {
    case "SAILOR": return "text-cyan-400";
    case "PIRATE": return "text-red-400";
    case "CULT_LEADER": return "text-amber-500";
    case "CULTIST": return "text-green-400";
    ...
    >
      <div className="flex items-center justify-between">
        <div>
          ...
          <div className="text-xs text-slate-500 mt-1">{t(`roles.${role}_DESC`)}</div>
        </div>
